...
func Nil(t testing.TB, v interface{}, msg ...interface{}) {
	if !isNil(v) {
...
func True(t testing.TB, v bool, msg ...interface{}) {
	if !v {
...
func False(t testing.TB, v bool, msg ...interface{}) {
	if v {
...
func NotNil(t testing.TB, v interface{}, msg ...interface{}) {
	if isNil(v) {
...
func Fail(t testing.TB, msg ...interface{}) {
