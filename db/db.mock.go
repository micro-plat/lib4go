...
// 	}
// }
// func (m *MDB) Query(sql string, input map[string]interface{}) (data QueryRows, err error) {
...
// 	return
// }
// func (m *MDB) Scalar(sql string, input map[string]interface{}) (data interface{},  err error) {
// 	query, args = m.tpl.GetSQLContext(sql, input)
// 	rows, err := m.db.Query(sql, args...)
// 	if err != nil {
// 		return nil, query, args, err
...
// 	return
// }
// func (m *MDB) Executes(sql string, input map[string]interface{}) (insertID int64, row int64, err error) {
// 	query, args = m.tpl.GetSQLContext(sql, input)
// 	result, err := m.db.Exec(query, args...)
// 	if err != nil {
// 		return
...
// 	return
// }
// func (m *MDB) ExecuteSP(procName string, input map[string]interface{}, output ...interface{}) (row int64, err error) {
