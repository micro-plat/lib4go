...
func TestDecrypt(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "1.5 ECB-不传入mode加解密", args: args{key: "13245687", cipherText: "中国李宁", mode: []string{""}}, wantPlainText: "", wantErr: true, wantErr1: true},
		...
		{name: "2.5 CBC-不传入mode加解密", args: args{key: "13245687", cipherText: "中国李宁", mode: []string{""}}, wantPlainText: "", wantErr: true, wantErr1: true},
