...
func Test_encryptData(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "1.5 CFB-不传入mode加解密", args: args{key: "1324568789123456", cipherText: "中国李宁", mode: []string{""}}, wantPlainText: "中国李宁", wantErr: false, wantErr1: false},
		...
		{name: "2.5 CBC-不传入mode加解密", args: args{key: "1324568789123456", cipherText: "中国李宁", mode: []string{""}}, wantPlainText: "中国李宁", wantErr: false, wantErr1: false},
		...
		{name: "3.5 CTR-不传入mode加解密", args: args{key: "1324568789123456", cipherText: "中国李宁", mode: []string{""}}, wantPlainText: "中国李宁", wantErr: false, wantErr1: false},
		...
		{name: "4.5 OFB-不传入mode加解密", args: args{key: "1324568789123456", cipherText: "中国李宁", mode: []string{""}}, wantPlainText: "中国李宁", wantErr: false, wantErr1: false},
